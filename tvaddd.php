...
if (empty($name_id) || empty($tiket)) {
 ...
 $query = "INSERT INTO `video` VALUES (NULL,'$name_id','$date','$tiket','$comment','$rm','$ops')";
...
<td>
<input type="text" name="name_id" value=""><br>
</td>
</tr>
<tr>
<th>
...
<td>
<input type="text" name="rm" value=""><br>
</td>
</tr>
<tr>
<th>
...
<td>
<input type="text" name="ops" value=""><br>
</td>
</tr>
<tr>
<th>
